...
hi Number          guifg=#90fe3b
hi String          guifg=#d7b0fe
hi Conditional     guifg=#32d932               gui=bold
...
hi Statement       guifg=#00ffff               gui=bold
...
if &t_Co > 255
   ...
   hi Number          ctermfg=154
   hi String          ctermfg=183
   hi Conditional     ctermfg=46               cterm=bold
